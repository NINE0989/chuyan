"""Web 端 AI 服务：接入 ai_pipeline LangGraph Agent 生成链路。"""
...
class AIService:
    ...
    def generate(self, prompt: str, adjust: bool = False, temperature: float = 0.7, top_p: float = 0.9) -> str:
        del temperature, top_p  # 由 ai_pipeline 内部策略控制
        ...
        # result.glsl_code 已由 generate_cli 经过 extract_glsl_code 处理，是纯 GLSL
